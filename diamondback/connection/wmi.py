...
class WMIConnection( Connection ):
    def __init__( self, target_address, username, password, port=135 ):
        ...
        self.logger = logging.getLogger( 'wmiconnection' )
        self.set_connection_type( 'wmi' )
        self.set_port( port )
        self.executer = None
    ...
    def open( self ):
        ...
        try:
            ...
            self.executer = WMIEXEC(command, username, password, domain, hashes, aesKey,
                            share, nooutput, k, dc_ip, target_ip, shell_type)
